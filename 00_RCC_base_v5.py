...
# v5 - using user feedback to make small improvements; removing unneccessary print statements,
# providing more instructions (such as for eggs, exit code and entering mixed fractions)
...
store_prices = []
# list for recipe price for ingredient (added together is total price)
...
print()
print()
print("An important note: \nWhen entering quantities of ingredients, please don't ever use"
      "mixed fractions, it will be processed as an error and you will receive an error message.")
print()
print()
...
serving_size = float_checker("Please enter the serving size for this recipe as an integer: ")

# while loop for ingredients
ingredient_name = ""

# instructions to give users control and freedom
print("When you are finished listing ingredients, please enter 'xxx' to exit.")
...
while ingredient_name != "Xxx":
    ...
    if ingredient_name == "Xxx":
        ...
        if ingredient_name == "Egg" or ingredient_name == "Eggs":
            print("Please note; when entering quantities of eggs please say the number of eggs and"
                  "the word eggs/egg.\nOtherwise the program will tell you  that you have not included the unit.")
        ...
        # append to list for pandas table
        store_quantities.append(store_quantity)
        ...
        # append to list for pandas table
        recipe_quantities.append(recipe_quantity)
